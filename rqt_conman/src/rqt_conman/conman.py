...
state_map = {
    ...
    conman_msgs.msg.TaskState.FATAL_ERROR: 'FatalError',
    conman_msgs.msg.TaskState.EXCEPTION: 'Exception',
    conman_msgs.msg.TaskState.STOPPED: 'Stopped',
    conman_msgs.msg.TaskState.RUNNING: 'Running',
    conman_msgs.msg.TaskState.RUN_TIME_ERORR: 'RunTimeError' }
